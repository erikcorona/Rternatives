//
// Created by Erik Corona on 11/23/16.
//
...
TEST(MESSAGES, test_mean)
{
    ...
    testResult(aaa,bbb,0.4375,0.1298122 , fastR::alternative::greater   );
    testResult(aaa,bbb,0.5625,0.03421812, fastR::alternative::less      );
